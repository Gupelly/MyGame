...
public class Boss : Monster
{
    ...
    private ParticleSystem effect1ref;
    private ParticleSystem effect1;
    private ParticleSystem effect2ref;
    ...
    private void Awake()
    {
        ...
        effect1ref = Resources.Load<ParticleSystem>("FirstAttackEffect");
        effect2ref = Resources.Load<ParticleSystem>("SecondAttackEffect");
    ...
    {
        if (effect1 == null) 
            effect1 = Instantiate(effect1ref, new Vector3(transform.position.x - transform.localScale.x, transform.position.y + 3.6f), Quaternion.identity);
        else Destroy(effect1);
    }
    ...
    {
        if (effect2 == null)
            effect2 = Instantiate(effect2ref, new Vector3(transform.position.x - transform.localScale.x * 0.2f, transform.position.y + 3.3f), Quaternion.identity);
        else Destroy(effect2);
    }
    ...
    {
        if (!IsInvisable) Instantiate(effect, new Vector3(transform.position.x, transform.position.y + 1.5f), Quaternion.identity);
    }
}
